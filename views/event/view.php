...
<?php if ($isAjax): ?>
    ...
    <div class="modal-body" style="padding-bottom: 0;">
        <?= EventCard::widget(['event' => $model, 'startCollapsed' => false]) ?>
    </div>
            ...
            <div class="col-md-12">
                <div class="panel panel-default">
                    <div class="panel-body">
                        <a href="<?= $model->content->container->createUrl('/crm/event/index') ?>" class="btn btn-default btn-sm" style="margin-bottom: 15px;">
