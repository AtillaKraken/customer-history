...
<div style="padding-top: 15px;">
    ...
    <div class="modal-body">
        ...
        <!-- default file upload (HumHub Standard) -->
        <div class="form-group">
            <label class="control-label">Dateien hochladen</label>
            <br>
            <?= UploadButton::widget([
                'id' => 'interaction_upload_button',
                'model' => $model,
                'attribute' => 'fileList',
                'progress' => '#interaction_upload_progress',
                'preview' => '#interaction_upload_preview',
            ]) ?>

            <div id="interaction_upload_progress" style="display:none; margin: 10px 0;"></div>
            <div id="interaction_upload_preview">
                <?= FilePreview::widget([
                    'id' => 'interaction_upload_preview',
                    'model' => $model,
                    'edit' => true
                ]) ?>
            </div>
